    ...
    with gr.Group():
        with gr.Row():
            llm_provider = gr.Dropdown(
                ...
                label="LLM Provider",
                value=os.getenv("DEFAULT_LLM", "deepseek"),
                info="Select LLM provider for LLM",
                interactive=True
            )
            llm_model_name = gr.Dropdown(
                label="LLM Model Name",
                choices=config.model_names[os.getenv("DEFAULT_LLM", "deepseek")],
                value=config.model_names[os.getenv("DEFAULT_LLM", "deepseek")][0],
                interactive=True,
